var OneTrustStub = function(t) {
    ...
    var s = "geo"
      ...
      , u = (i.Name,
    "PRODUCTION")
      , n = ((m = {})[g.Days] = "PCenterVendorListLifespanDay",
    m[g.Weeks] = "LfSpnWk",
    ...
    h.prototype.getLocation = function(t) {
        ...
        this.addBannerSDKScript(t)) : (i = this.readCookieParam(p.optanonCookieName, p.geolocationCookiesParam)) || t.SkipGeolocation ? (e = i.split(";")[0],
        i = i.split(";")[1],
    ...
    h.prototype.getGeolocationURL = function(t) {
        ...
        p.storageBaseURL + e) : t.GeolocationUrl
    }
    ,
    ...
    h.prototype.validateIABGlobalScope = function() {
        ...
        t ? "true" === t ? (p.hasIABGlobalScope = !0,
        p.isStubReady = !1) : (p.hasIABGlobalScope = !1,
        p.IABCookieValue = this.getCookie(p.oneTrustIABCookieName)) : p.isStubReady = !1
    }
    ,
    ...
    h.prototype.updateGtmMacros = function() {
        for (var t = [], e = p.optanonHtmlGroupData.length, i = 0; i < e; i++)
            this.endsWith(p.optanonHtmlGroupData[i], ":1") && t.push(p.optanonHtmlGroupData[i].replace(":1", ""));
        for (e = p.optanonHostData.length,
        i = 0; i < e; i++)
            this.endsWith(p.optanonHostData[i], ":1") && t.push(p.optanonHostData[i].replace(":1", ""));
        for (e = p.genVendorsData.length,
        i = 0; i < e; i++)
            this.endsWith(p.genVendorsData[i], ":1") && t.push(p.genVendorsData[i].replace(":1", ""));
        for (e = p.vendorsServiceData.length,
        i = 0; i < e; i++)
    ...
    h.prototype.setStubScriptElement = function() {
        ...
        p.stubScriptElement && p.stubScriptElement.hasAttribute(p.DATAFILEATTRIBUTE) ? this.domainId = p.stubScriptElement.getAttribute(p.DATAFILEATTRIBUTE).trim() : t ? this.domainId = t : p.stubScriptElement || (p.stubScriptElement = document.querySelector("script[src*='" + p.migratedCCTID + "']"),
        p.stubScriptElement && (p.isMigratedURL = !0,
    ...
    h.prototype.setDomainDataFileURL = function() {
        ...
        t && (p.isMigratedURL ? p.storageBaseURL = t.split("/consent/" + p.migratedCCTID)[0] : p.storageBaseURL = (e ? t.split("/consent") : t.split("/scripttemplates/" + p.stubFileName))[0]),
    ...
    h.prototype.updateVersion = function(t) {
        "debug" !== this.buildType && "cybuild" !== this.buildType || (t.Version = "202409.1.0")
    }
    ,
    h);
    function h() {
        ...
        this.addBannerSDKScript = function(t) {
            ...
            p.stubScriptElement.cloneNode(!0))
              , n = ""
              , n = t.UseSDKRefactor ? (p.isMigratedURL && (i.src = p.storageBaseURL + "/scripttemplates/new/scripttemplates/" + p.stubFileName + ".js"),
            p.storageBaseURL + "/scripttemplates/new/scripttemplates/" + t.Version + "/" + p.bannerScriptName) : "5.11.0" === t.Version ? (p.isMigratedURL && (i.src = p.storageBaseURL + "/scripttemplates/old/scripttemplates/" + p.stubFileName + ".js"),
            p.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + p.bannerScriptName) : (p.isMigratedURL && (i.src = p.storageBaseURL + "/scripttemplates/" + p.stubFileName + ".js"),
        ...
        this.getPingRequest = function(t, e) {
            ...
            void 0 === e && (e = !1),
            t && (i = !(e = {}),
            "IAB2" !== s.iabType && "IAB2V2" !== s.iabType || (e = {
